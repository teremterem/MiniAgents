...
class OpenAIEmbedding(BaseEmbedding):
    ...
    api_base: Optional[str] = Field(default=DEFAULT_OPENAI_API_BASE, description="The base URL for OpenAI API.")
    api_version: Optional[str] = Field(default=DEFAULT_OPENAI_API_VERSION, description="The version for OpenAI API.")

    max_retries: int = Field(default=10, description="Maximum number of retries.", gte=0)
