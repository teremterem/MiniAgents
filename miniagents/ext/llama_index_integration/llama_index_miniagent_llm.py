...
class LlamaIndexMiniAgentLLM(FunctionCallingLLM):
    ...
    model: str = Field(default=DEFAULT_OPENAI_MODEL, description="The OpenAI model to use.")
    ...
    logprobs: Optional[bool] = Field(description="Whether to return logprobs per token.")
    ...
    default_headers: Dict[str, str] = Field(default=None, description="The default headers for API requests.")
